...
var dockerapi = new Dockerode({socketPath: '/var/run/docker.sock'});
...
Docker.prototype.createExec = function (id,callback) {
  request({
    url:"http://127.0.0.1:4243/containers/"+id+"/exec",
    method:"POST",
    body:{
      AttachStdout: true,
      AttachStderr: true,
...
Docker.prototype.getContainer = dockerapi.getContainer;
